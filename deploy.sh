...
Environment=ALIYUN_APP_KEY=\${ALIYUN_APP_KEY}
...
Environment=OSS_BUCKET_MJ_WORD_PARAPHRASE=\${OSS_BUCKET_MJ_WORD_PARAPHRASE}
Environment=ENV=\${ENV}
Environment=ALIYUN_COMMON_ID=\${ALIYUN_COMMON_ID}
Environment=ALIYUN_COMMON_SECRET=\${ALIYUN_COMMON_SECRET}
Environment=AZURE_OPENAI_API_KEY=\${AZURE_OPENAI_API_KEY}
Environment=AZURE_OPENAI_ENDPOINT=\${AZURE_OPENAI_ENDPOINT}
